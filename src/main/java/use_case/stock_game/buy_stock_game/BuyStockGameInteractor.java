...
public class BuyStockGameInteractor implements BuyStockGameInputBoundary {

    private final BuyStockGameDataAccessInterface stockGameDataAccessObject;
    private final BuyStockGameOutputBoundary stockGamePresenter;

    public BuyStockGameInteractor(BuyStockGameDataAccessInterface buyStockGameDataAccessInterface,
                                  BuyStockGameOutputBoundary buyStockGameOutputBoundary){
        this.stockGameDataAccessObject = buyStockGameDataAccessInterface;
        this.stockGamePresenter = buyStockGameOutputBoundary;
    }
